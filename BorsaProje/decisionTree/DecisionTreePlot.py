...
# Gerçek ve tahmin değerlerini göstermek için hem nokta hem de çizgi grafiği kullan
plt.figure(figsize=(12, 6))

# Nokta grafiği (scatter plot) - Gerçek Değerler
plt.scatter(range(len(y_test)), y_test.values, color='blue', label='Gerçek Değerler', marker='o', s=50)

# Çizgi grafiği (line plot) - Tahmin Edilen Değerler
plt.plot(y_pred, color='red', label='Tahmin Edilen Değerler', linestyle='-', linewidth=2)
